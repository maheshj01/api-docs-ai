...
export default class Constants {
    ...
    static styles = {
        inputClassName: 'w-full p-3 bg-gray-700/50 text-white rounded-lg border border-gray-600 outline-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 ease-in-out',
